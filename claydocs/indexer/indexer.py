...
class Indexer:
    ...
    def _get_documents(self, pages: "list[Page]") -> dict[str, TSections]:
        logger.info("Rendering pages for indexing...")
        documents = {}
        for page in pages:
            documents.setdefault(page.lang, {})
            documents[page.lang].update(self._extract_page_data(page))
        return documents
    ...
    def _index_lang(self, lang: str, docs: TSections) -> dict:
