...
function handleSelection(event) {
  const target = event.target.closest(SEL_TAB)
...
function handleKeyDown(event) {
  ...
  const currIndex = Array.prototype.indexOf.call(tabs, event.target) || 0
  let newIndex
